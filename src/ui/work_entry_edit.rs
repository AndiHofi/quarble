...
impl WorkEntryEdit {
    pub fn new(id: usize) -> Box<Self> {
        Box::new(Self {
            id,
            _edit: true,
            _min_time: Time::hm(0, 0),
            _max_time: Time::hm(24, 0),
            _time_resolution: NonZeroU32::new(15).unwrap(),
